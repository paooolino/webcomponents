...
describe('[actions_spec]', () => {
    ...
    describe('Sync action creators', () => {
        ...
        describe('fetchItems', () => {
            ...
            it('should create an action to success an items fetch', () => {
                ...
                expect(creators.fetchItemsSuccess(serverData)).toEqual({
    ...
    describe('Async action creators', () => {
        ...
        it('should create an async action to fetch items', () => {
             expect(creators.fetchItems()).toBeA('function');
        });
        it('should create an async action to add an item', () => {
             expect(creators.addItem()).toBeA('function');
        });
        it('should create an async action to delete an item', () => {
             expect(creators.deleteItem()).toBeA('function');
        });
        it('should create an async action to save an item field', () => {
    ...
    describe('Async action behaviour', () => {
        ...
        it('should dispatch request and success actions when login has been dispatched', () => {
            nock(ENDPOINT_HOST)
                .post(ENDPOINT_PATH)
                .reply(200, {status: 'ok'});
            ...
            return store.dispatch(creators.login())
        ...
        it('should dispatch request and success actions when requestLanguages has been dispatched', () => {
            ...
            const expectedActions = [
                { type: types.GET_LANGUAGES_REQUEST },
                { type: types.GET_LANGUAGES_SUCCESS, languages: ['it', 'en'] }
            ];
            const store = mockStore({});
        ...
        it('should dispatch request and success actions when fetchItems has been dispatched', () => {
            nock(ENDPOINT_HOST)
                .post(ENDPOINT_PATH)
                .reply(200, {
                    status: 'ok',
            ...
            const expectedActions = [
                { type: types.FETCH_ITEMS_REQUEST },
                { type: types.FETCH_ITEMS_SUCCESS, items: [{id: 1}, {id: 2}] }
            ];
            const store = mockStore({});
            return store.dispatch(creators.fetchItems())
                .then(() => { // return of async actions
                expect(store.getActions()).toEqual(expectedActions)
            })
        });
        it('should dispatch request and success actions when addItem has been dispatched', () => {
            nock(ENDPOINT_HOST)
                .post(ENDPOINT_PATH)
                .reply(200, {status: 'ok'});
            ...
            const store = mockStore({});
            return store.dispatch(creators.addItem())
                .then(() => { // return of async actions
                expect(store.getActions()).toEqual(expectedActions)
            })
        });
        it('should dispatch request and success actions when deleteItem has been dispatched', () => {
            nock(ENDPOINT_HOST)
                .post(ENDPOINT_PATH)
                .reply(200, {status: 'ok'});
            ...
            const store = mockStore({});
            return store.dispatch(creators.deleteItem())
                .then(() => { // return of async actions
                expect(store.getActions()).toEqual(expectedActions)
            })
        });
        it('should dispatch request and success actions when saveItemField has been dispatched', () => {
            nock(ENDPOINT_HOST)
                .post(ENDPOINT_PATH)
                .reply(200, {status: 'ok'});
            ...
            const store = mockStore({});
            return store.dispatch(creators.saveItemField())
                .then(() => { // return of async actions
                expect(store.getActions()).toEqual(expectedActions)
            })
        });
