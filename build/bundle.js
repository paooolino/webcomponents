...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HeaderBar = __webpack_require__(184);

	var _HeaderBar2 = _interopRequireDefault(_HeaderBar);

	var _AppBodyContainer = __webpack_require__(189);

	var _AppBodyContainer2 = _interopRequireDefault(_AppBodyContainer);

	var _StatusBar = __webpack_require__(197);

	var _StatusBar2 = _interopRequireDefault(_StatusBar);

	var _LoginFormContainer = __webpack_require__(200);
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'appbody' },
	                    this.props.isAuthenticated && _react2.default.createElement(_AppBodyContainer2.default, null)
	                ),
	                _react2.default.createElement(_StatusBar2.default, null),
	                !this.props.isAuthenticated && _react2.default.createElement(_LoginFormContainer2.default, null)
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DataTable = __webpack_require__(190);

	var _DataTable2 = _interopRequireDefault(_DataTable);

	var _itemsActions = __webpack_require__(193);
	...
	var AppBodyContainer = function (_Component) {
	    _inherits(AppBodyContainer, _Component);

	    function AppBodyContainer(props) {
	        _classCallCheck(this, AppBodyContainer);
	        ...
	        _this.selectItemHandler = function (id) {
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps)(AppBodyContainer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataTable = function DataTable(_ref) {
	    ...
	    var last_added_id = _ref.last_added_id;
	    var last_deleted_id = _ref.last_deleted_id;
	    var selected_id = _ref.selected_id;
	    var addItemHandler = _ref.addItemHandler;
	    var deleteItemHandler = _ref.deleteItemHandler;
	    var selectItemHandler = _ref.selectItemHandler;
	    return _react2.default.createElement(
	        'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".selected td {\n    background-color:#ddd;\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	//
	var FETCHITEMS_REQUEST = exports.FETCHITEMS_REQUEST = 'FETCHITEMS_REQUEST';
	var FETCHITEMS_FAILURE = exports.FETCHITEMS_FAILURE = 'FETCHITEMS_FAILURE';
	var FETCHITEMS_SUCCESS = exports.FETCHITEMS_SUCCESS = 'FETCHITEMS_SUCCESS';

	var ADDITEM_REQUEST = exports.ADDITEM_REQUEST = 'ADDITEM_REQUEST';
	var ADDITEM_FAILURE = exports.ADDITEM_FAILURE = 'ADDITEM_FAILURE';
	var ADDITEM_SUCCESS = exports.ADDITEM_SUCCESS = 'ADDITEM_SUCCESS';

	var DELETEITEM_REQUEST = exports.DELETEITEM_REQUEST = 'DELETEITEM_REQUEST';
	var DELETEITEM_FAILURE = exports.DELETEITEM_FAILURE = 'DELETEITEM_FAILURE';
	...
	var deleteItem = function deleteItem(id) {
	    return (0, _utils.createAsyncAction)("deleteItem", { id: id }, DELETEITEM_REQUEST, DELETEITEM_FAILURE, DELETEITEM_SUCCESS);
	};
	...
	//
	exports.fetchItems = fetchItems; // this is ES6 syntax to export a function defined earlier
...
/***/ function(module, exports, __webpack_require__) {
	...
	var API_ENDPOINT = "http://webcomponents-paooolino1.c9users.io/web/server/endpoint.php";
	...
	function createAsyncAction(actionName, data, request, error, success) {
	    ...
	    return function (dispatch) {
	        ...
	        return (0, _isomorphicFetch2.default)(API_ENDPOINT, config).then(function (response) {
	            var json = void 0;
	            if (!response.ok) {
	                dispatch({
	                    type: error,
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./StatusBar.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./StatusBar.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".statusBar{\n    position: fixed;\n    bottom: 0;\n    left: 0;\n    width: 100%;\n    background-color:#333;\n    color: #eee;\n    font-size: 10pt;\n}\n.statusBar.container{padding:10px;}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoginForm = __webpack_require__(201);

	var _LoginForm2 = _interopRequireDefault(_LoginForm);

	var _authActions = __webpack_require__(251);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        onSubmit: function onSubmit(data) {
	            dispatch((0, _authActions.login)(data.username, data.password));
	        }
	    };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _validation = __webpack_require__(250);
	...
	var LoginForm = function LoginForm(_ref) {
	    ...
	    var username = _ref$fields.username;
	    var password = _ref$fields.password;
	    ...
	    return _react2.default.createElement(
	        'div',
	        { className: 'loginformpicture' },
	        _react2.default.createElement(
	            'div',
	            { className: 'loginformopacity' },
	            _react2.default.createElement(
	                'div',
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'form',
	                        { className: 'inner', onSubmit: handleSubmit },
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'formrow' },
	                            _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'formfield' },
	                                _react2.default.createElement('input', _extends({ type: 'text', placeholder: 'Username' }, username))
	                            )
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                            ...
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'formfield' },
	                                _react2.default.createElement('input', _extends({ type: 'password', placeholder: 'Password' }, password))
	                            )
	                        ),
	                        !isFetching && _react2.default.createElement(
	                            'div',
	...
	var validate = (0, _validation.createValidator)({
	    username: [_validation.required, (0, _validation.minLength)(3)],
	    password: [_validation.required, (0, _validation.minLength)(5)]
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createAll2 = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getValuesFromState = __webpack_require__(209);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _read = __webpack_require__(207);

	var _read2 = _interopRequireDefault(_read);

	var _write = __webpack_require__(208);
	...
	var _initializeState = __webpack_require__(211);

	var _initializeState2 = _interopRequireDefault(_initializeState);

	var _resetState = __webpack_require__(212);

	var _resetState2 = _interopRequireDefault(_resetState);

	var _setErrors = __webpack_require__(213);

	var _setErrors2 = _interopRequireDefault(_setErrors);

	var _fieldValue = __webpack_require__(210);

	var _normalizeFields = __webpack_require__(214);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _noGetters = __webpack_require__(217);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _silenceEvents = __webpack_require__(244);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createOnBlur = __webpack_require__(230);

	var _createOnBlur2 = _interopRequireDefault(_createOnBlur);

	var _createOnChange = __webpack_require__(233);
	...
	var _createOnDrop = __webpack_require__(235);

	var _createOnDrop2 = _interopRequireDefault(_createOnDrop);

	var _createOnFocus = __webpack_require__(236);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.login = exports.LOGIN_SUCCESS = exports.LOGIN_FAILURE = exports.LOGIN_REQUEST = undefined;
	...
	var login = function login(username, password) {
	    return (0, _utils.createAsyncAction)("login", { username: username, password: password }, LOGIN_REQUEST, LOGIN_FAILURE, LOGIN_SUCCESS);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".appbody{\n    padding-top:60px;\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _authReducer = __webpack_require__(255);

	var _authReducer2 = _interopRequireDefault(_authReducer);

	var _itemsReducer = __webpack_require__(256);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function items() {
	    ...
	    switch (action.type) {
	        case _itemsActions.FETCHITEMS_REQUEST:
	            return _extends({}, state, {
	                isFetching: true,
	                errorMessage: ''
	            });

	        case _itemsActions.FETCHITEMS_FAILURE:
	            return _extends({}, state, {
	                isFetching: false,
	                errorMessage: action.payload.errorMessage
	            });

	        case _itemsActions.FETCHITEMS_SUCCESS:
	            return _extends({}, state, {
	                isFetching: false,
	        ...
	        case _itemsActions.ADDITEM_FAILURE:
	            return _extends({}, state, {
	                isFetching: false,
	                errorMessage: action.payload.errorMessage
	            });

	        case _itemsActions.ADDITEM_SUCCESS:
	            return _extends({}, state, {
	                isFetching: false,
	        ...
	        case _itemsActions.DELETEITEM_FAILURE:
	            return _extends({}, state, {
	                isFetching: false,
	                errorMessage: action.payload.errorMessage
	            });

	        case _itemsActions.DELETEITEM_SUCCESS:
	            return _extends({}, state, {
	                isFetching: false,
